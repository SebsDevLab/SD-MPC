...
% 
% 
function ref = Smooth_Step_to_Sinus_paper_LTI(T_sim, ny, T_fut, ini_len, smooth_len, step_len, sin_period_len, y_0, y_step, y_sin)
    % Smooth Step:
