...
% 
% 
function ref = Smooth_Step_to_Sinus_paper_LPV(T_sim, ny, T_fut, ini_len, smooth_len, step_len, sin_period_len, y_0, y_step, y_sin)
    % Smooth Step:
    ref = y_0 * ones(ny, T_sim + T_fut);
    ref(ny, ini_len:ini_len+smooth_len) = y_step/15*[linspace(0,14,24), 14.5, 14.75, 14.88 ,14.95];
